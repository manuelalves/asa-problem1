...
int main(){
    ...
    //[2 - Tamanho do maior grupo maximo de pessoas que partilham informacao]
    int max_groups = 0;
    ...
    //[3 - Numero de grupos maximos de pessoas que partilham informacao apenas dentro do grupo]
    for(unsigned int itr = 0; itr < scComponents.size(); itr++){       // iterates the SSC vector
    ...
    //OUTPUT
    //[1 - Numero de grupos maximos de pessoas que partilham informacao]
